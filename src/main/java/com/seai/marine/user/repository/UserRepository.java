...
public class UserRepository {
    ...
    private static final String REGISTER_USER_QUERY = "INSERT INTO sailors (user_id, first_name, last_name, rank, " +
    ...
    private static final String UPDATE_USER_QUERY = "UPDATE sailors SET first_name=?, last_name=?," +
            " rank=?, present_employer=?, date_of_birth=?, manning_agents=?, status=?, vessel_type=?, home_airport=?, " +
            "readiness_date=?, contract_duration=?, phone=?, address=?, nationality=? WHERE user_id=?";
    ...
    private static final String FIND_USER_BY_ID_QUERY = "SELECT user_id, first_name, last_name, rank," +
            ...
            " vessel_type, home_airport, readiness_date, contract_duration, phone, address, nationality " +
            "FROM sailors WHERE user_id= ?";
