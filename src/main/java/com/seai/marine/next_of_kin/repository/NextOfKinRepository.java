package com.seai.marine.next_of_kin.repository;
...
public class NextOfKinRepository {
    ...
    public Optional<NextOfKin> findByUserId(UUID userId) {
        return jdbcTemplate.query(FIND_NEXT_OF_KIN_BY_USER_ID_QUERY, getNextOfKinRowMapper(), userId.toString())
                .stream()
                .findFirst();
    }
