...
public class ReminderRepository {
    ...
    private static final String CREATE_REMINDER_QUERY = "INSERT INTO reminders (user_id, email) VALUES (?, ?)";
    private static final String DELETE_REMINDER_QUERY = "DELETE FROM reminders WHERE user_id = ?";
    private static final String FIND_REMINDER_BY_USER_ID_QUERY = "SELECT user_id, email FROM reminders WHERE user_id = ?";

    private final JdbcTemplate jdbcTemplate;

    public void saveReminder(UUID user_id, String user_email) {
        jdbcTemplate.update(CREATE_REMINDER_QUERY, user_id, user_email);
    }
