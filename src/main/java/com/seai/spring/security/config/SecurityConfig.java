    ...
    public SecurityFilterChain usersFilterChain(HttpSecurity http) throws Exception {
        http.securityMatcher("/api/v1/users/**", "/api/v1/ships/**").csrf(AbstractHttpConfigurer::disable)
                .authorizeHttpRequests(request -> request
                        ...
                        .permitAll()
                        .requestMatchers(HttpMethod.PUT, "/api/v1/users", "/api/v1/users/reset-password/request")
                        .permitAll()
                        .requestMatchers(HttpMethod.POST, "/api/v1/users", "/api/v1/users/reset-password")
                        .permitAll()
